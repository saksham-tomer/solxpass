...
const MarqueeEffect = () => {
  return (
    <div className="min-w-screen h-44 bg-orange-600 border-t-4 border-b-4  border-black top-[42rem] rotate-3 z-20 overflow-hidden relative">
      ...
      <div className="flex items-center h-full animate-marquee">
        {[...Array(10)].map((_, index) => (
          <React.Fragment key={index}>
            <span className="text-black text-6xl font-bold mx-4">SOLXPASS</span>
