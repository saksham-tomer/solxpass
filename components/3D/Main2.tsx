...
function Main2() {
  return (
    <div className="bg-orange-600 flex items-center justify-center absolute top-[52rem] flex-col bottom-0 min-w-full min-h-screen mt-0">
      <button className="p-4 md:p-4 xl:p-8 md:-top-20 font-bold rounded-full absolute bottom-auto -top-16 border-8 border-orange-600 bg-neutral-800 hover:bg-neutral-700 transition-colors duration-300 flex items-center justify-center">
      ...
      <h1 className="lg:text-elephant md:text-9xl text-6xl font-impact leading-tight mt-28 text-white mb-auto tracking-tight">
      ...
      <p className="font-impact leading-tight text-orange-100 max-w-96 text-sm md:text-2xl text-left mb-[30rem] ">
        Some more free than others reality has evolved beyond the physical to
        FACILITATE & create new digital tribes
      </p>
